...
The solution of the task is located in the file "Task-1-1.py".

RobotTask-1-1. Занятия по Python. Исполнитель Робот. Платформа StepInDev. 
...
Решение задачи находится в файле "Task-1-1.py".
